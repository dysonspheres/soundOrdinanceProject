...
# time between date applied and date issued
...
'''
ggplot(df_times, aes(x = IN_DATE, y = time_diff)) + 
  geom_line(group = 1, color = "blue") + 
  geom_point(color = "red") +
  labs(x = "ID", y = "Time Difference (Days)", title = "Time Difference Between Date Applied and Date Issued") +
  theme_minimal()
'''

...
df$END_HOURS_NOT_NEAR_HOME <- gsub("12AM 12AM,", "12:00am", df$END_HOURS_NOT_NEAR_HOME) #12AM 12AM,
...
print(paste("Number of NAs:", num_nas, nrow(df)))
df <- df %>% filter(!is.na(EVENT_MONTH))
unique(df$EVENT_MONTH)
